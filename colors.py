...
plt.rcParams['axes.prop_cycle'] = cycler('color', tableau_10)
plt.rcParams['xtick.direction'] = 'out'
plt.rcParams['ytick.direction'] = 'out'
plt.rcParams["font.family"] = "stix"
plt.rcParams["mathtext.fontset"] = "stix"

def set_plt_scale(s=1):
   plt.rcParams["figure.figsize"] = (24*s,18*s)
   plt.rcParams["font.size"] = 85*s
   plt.rcParams["axes.labelsize"] = 85*s
   plt.rcParams['axes.linewidth'] = 5*s
   plt.rcParams['lines.linewidth'] = 9*s
   plt.rcParams['xtick.major.width'] = 7.5*s
   plt.rcParams['ytick.major.width'] = 7.5*s
   plt.rcParams['xtick.major.size'] = 20*s
   plt.rcParams['ytick.major.size'] = 20*s
   plt.rcParams['lines.markersize'] = 20*s
   plt.rcParams['legend.fontsize'] = 50*s
